...
public class Notification extends AppCompatActivity {
    ...
    private void initData() {
        ...
        notifications.add(new com.example.model.Notifications("Bạn còn 1 tiếng trước buổi học Ielts của giáo viên Andrew"));
        ...
        notifications.add(new com.example.model.Notifications("Giáo viên Tường Thanh đã update tài liệu sau buổi học ngày 20/11/2022. Chúc bạn học tập vui vẻ."));
        notifications.add(new com.example.model.Notifications("Giáo viên Trần Tùng đã update tài liệu sau buổi học ngày 22/11/2021. Chúc bạn học tập vui vẻ."));
